class Mouth {
  ...
  display() {
    ...
    beginShape();
    for (let i = 44; i <= 50; i++) {
      vertex(this.positions[i][0], this.positions[i][1]);
    }
    vertex(this.positions[59][0], this.positions[59][1]);
    vertex(this.positions[60][0], this.positions[60][1]);
    vertex(this.positions[61][0], this.positions[61][1]);
  ...
  measure() {
    if (this.positions.length > 0) {
      ...
      //console.log(height)
      rect(20, 20, this.mouthWidth * 3, 20);
      rect(20, 40, this.mouthHeight * 5, 20);
    }
  }
